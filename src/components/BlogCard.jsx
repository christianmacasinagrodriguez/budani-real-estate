    ...
    <div className="w-full md:w-fit lg:w-fit xl:w-fit h-fit flex flex-col bg-white hover:-translate-y-1 transition-all duration-500">
      <div className="w-full md:w-[385px] lg:w-[385px] h-[230px]">
        <Image
          width="20000"
          height="20000"
          className="w-full h-full object-cover object-center hover:brightness-110"
          src={imageSRC}
          alt="blog-image"
        />
      </div>
      <div className="w-[100%] md:w-[385px] lg:w-[385px] flex flex-col gap-5 items-center py-[27px] px-5">
        ...
        <h2
          className="w-full text-2xl font-bold  text-[#3C414E] truncate hover:cursor-pointer"
          onClick={passBlogData}
        >
          {blogTitle}
        </h2>
      </div>
