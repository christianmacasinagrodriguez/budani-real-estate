...
function Navbar( { pageStat, onBlogPage, blogActive, contactActive}) {
  ...
  return (
    <nav className={`${navBehavior} top-0 inset-x-0 py-[30px] text-white flex flex-row justify-between px-[5%] mx-0 md:mx-[5%] lg:mx-[5%] xl:mx-[5%] border-b-[1px] border-white border-opacity-50 z-20`}>
