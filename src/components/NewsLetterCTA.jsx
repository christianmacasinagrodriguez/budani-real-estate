  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-[90%] lg:w-full xl:w-[60%] text-white flex flex-col md:flex-row lg:flex-row gap-[20px] self-center">
        ...
        <button className="w-full md:w-[174px] lg:w-[174px] h-[61px]  bg-white text-[#6663E9] text-lg font-extrabold leading-[180%] rounded-[40px] shadow-[0px_4px_60px_0px_rgba(0, 0, 0, 0.05)]">
          Subscribe
        </button>
      </div>
    </div>
