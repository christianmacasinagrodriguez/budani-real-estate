...
function RealEstateCard({ translateYNM, translateYMD, translateYLG }) {
  ...
  return (
    <div className={`w-fit h-fit relative ${translateYNM} ${translateYMD} ${translateYLG} font-${manrope.className}` }>
        <img className='w-[366px] h-[400px] object-cover object-center rounded-[20px] shadow-[0px_4px_120px_rgba(58, 86, 78, 0.07)]' src='https://images.pexels.com/photos/106399/pexels-photo-106399.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='Mixtownia-image'>
        </img>
